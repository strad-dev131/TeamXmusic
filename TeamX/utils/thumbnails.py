...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("TeamX/assets/font2.ttf", 30)
        font = ImageFont.truetype("TeamX/assets/font.ttf", 30)
        title_font = ImageFont.truetype("TeamX/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("TeamX/assets/play_icons.png")
