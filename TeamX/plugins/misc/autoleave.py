...
from TeamX.core.call import TeamX, autoend, counter
from TeamX.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await TeamX.call_listeners(chat_id))
